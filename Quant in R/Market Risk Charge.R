...
# a) -------
# Discrete returns for McDonalds, Apple and JP Morgan for the period 02.12.2019 - 01.12.2020
...
# b) --- portfolio weight (MCD=0.1,APP=0.4,JPM=0.5)
...
# c) --- continuous returns for the three stocks and the portfolio.
...
# Plot together the PDFs of a normal and of a Laplace distributions
# µ = 0.005 and σ2 = 0.0017
mu <- 0.005
sigma2 <- 0.0017
